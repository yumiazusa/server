<?php
use Jialeo\LaravelSchemaExtend\Schema as JiaSchema;
...
class CreateTestPicsTable extends Migration
{
    ...
    public function up()
    {
        JiaSchema::create('test_pics', function (Blueprint $table) {
            $table->comment = '测试图片管理表';
